package org.geoserver.wfs.format.ext.SevenZip;
...
public class LzmaAlone
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		if (params.Command == CommandLine.kBenchmak)
		{
			...
			org.geoserver.wfs.format.ext.SevenZip.LzmaBench.LzmaBenchmark(params.NumBenchmarkPasses, dictionary);
		}
		else if (params.Command == CommandLine.kEncode || params.Command == CommandLine.kDecode)
		{
			...
			{
				org.geoserver.wfs.format.ext.SevenZip.Compression.LZMA.Encoder encoder = new org.geoserver.wfs.format.ext.SevenZip.Compression.LZMA.Encoder();
			...
			else
			{
				...
				org.geoserver.wfs.format.ext.SevenZip.Compression.LZMA.Decoder decoder = new org.geoserver.wfs.format.ext.SevenZip.Compression.LZMA.Decoder();
